...
# Export File
$exportFile = "C:\Temp\$(Get-Date -Format yyyy-MM-dd-HH-mm) - EXO - InboundConnector.csv"

Get-InboundConnector | Select-Object * | Export-Csv -Path $exportFile -Encoding utf8 -NoTypeInformation
