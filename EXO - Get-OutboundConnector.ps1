...
# Export File
$exportFile = "C:\Temp\$(Get-Date -Format yyyy-MM-dd-HH-mm) - EXO - OutboundConnector.csv"

Get-OutboundConnector | Select-Object * | Export-Csv -Path $exportFile -Encoding utf8 -NoTypeInformation

<#
#Get Conditional Access Policies   
$tempAR = @(Get-TransportRule) | Select-Object *
