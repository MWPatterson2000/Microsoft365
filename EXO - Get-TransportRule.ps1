...
# Export File
$exportFile = "C:\Temp\$(Get-Date -Format yyyy-MM-dd-HH-mm) - EXO - TransportRule.csv"

Get-TransportRule | Select-Object * | Export-Csv -Path $exportFile -Encoding utf8 -NoTypeInformation
